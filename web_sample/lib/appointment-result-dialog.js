...
define("appointment-result-dialog", [
  "jquery",
  "MedMe",
  "medme-app",
  "text!../partials/appointment-result-dialog.html",
  "bootstrap",
  ...
  return {
    render: function (containerElement) {
      ...
      $("#appointment-result-dialog").on("shown.bs.modal", function (e) {
        ...
        medmeApp.appointmentResultService.getAppointmentResultById(
          id,
          (err, appresult) => {
            ...
            document.querySelector("#appResult-text pre").innerText =
              formatter.appointmentResult(appresult);
          }
        );
      });
    },

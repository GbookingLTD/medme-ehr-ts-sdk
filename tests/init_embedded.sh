...
echo "update UserIDMap SET Created=\"$now\", InternalId=\"1\", UserSign=\"$sign\" where PublicId=\"user999\"" | sqlite3 $1
echo "insert or ignore into UserIDMap (Created, PublicId, InternalId, UserSign) VALUES (\"$now\", \"user999\", \"1\", \"$sign\")" | sqlite3 $1

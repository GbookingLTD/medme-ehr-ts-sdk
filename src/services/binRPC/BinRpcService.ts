import { RpcRequestHeader, IBinaryRequest, IBodyWriter, IRpcResponseCallback,
    REQUEST_HEADER_ALLOCATE_BYTES_LENGTH } from "./BinRpcRequest";
...
export class BinRPCService {
    ...
    public exec(rpcHandler: number, bodyWriter: IBodyWriter, cb: IRpcResponseCallback): void {
        ...
        this._request(header,
            new Uint8Array(buffer, 0, REQUEST_HEADER_ALLOCATE_BYTES_LENGTH + body.buffer.length), cb);

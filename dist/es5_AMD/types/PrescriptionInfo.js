define(["require", "exports", "./Doctor", "./Medication", "./Period"], function (require, exports, Doctor_1, Medication_1, Period_1) {
    "use strict";
    ...
    var PrescriptionInfo = /** @class */ (function () {
        ...
        PrescriptionInfo.prototype.fromJson = function (json) {
            ...
            this.validityPeriod = json.validityPeriod ? (new Period_1.Period()).fromJson(json.validityPeriod) : new Period_1.Period();

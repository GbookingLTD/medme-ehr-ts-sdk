...
var AppointmentResultModel = /** @class */ (function () {
    ...
    AppointmentResultModel.prototype.fromJson = function (json) {
        ...
        this._diagnosis = json.diagnosis
            ? json.diagnosis.map(function (d) { return new Diagnosis(d); })
            : [];
        this._recommendations = json.recommendations
            ? json.recommendations.map(function (r) { return new Procedure().fromJson(r); })
            : [];
        this._scheduledProcedures = json.scheduledProcedures
            ? json.scheduledProcedures.map(function (p) { return new Procedure().fromJson(p); })
            : [];
        this._prescriptions = json.prescriptions
            ? json.prescriptions.map(function (p) { return new PrescriptionInfo().fromJson(p); })
            : [];

...
export { PatientAuthenticationResult };
/**
 * Перечисление шагов сценария аутентификации пациента.
 */
export var PatientAuthenticationStep;
...
export { PatientAuthenticationError };
 ...
 * @param {function} cb
 */
export function getAuthenticatedPatient(patientService, authService, patientInput, cb) {

...
export declare class AppointmentService extends JsonRPCCredService implements IAppointmentService {
    ...
    getPatientAppointments(patientId: string, limit: number, offset: number, cb: (err: any, appointments: AppointmentMessage[]) => void, OrderByDescendingDate?: boolean): void;
    getPatientAppointmentsAsync(patientId: string, limit: number, offset: number, OrderByDescendingDate?: boolean): Promise<AppointmentMessage[]>;

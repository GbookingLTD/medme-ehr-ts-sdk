...
var PatientService = /** @class */ (function (_super) {
    ...
    PatientService.prototype.getPatients = function (limit, offset, lastId, prevCreated, cb) {
        ...
        this.exec(Handlers.HANDLER_GET_PATIENTS_METHOD, params, function (err, payload) {
            if (err)
                return cb(err, null);
    ...
    PatientService.prototype.findPatientsByPhone = function (phone, limit, offset, cb) {
        this.exec(Handlers.HANDLER_FIND_PATIENTS_BY_PHONE_METHOD, { phone: phone, limit: limit, offset: offset }, function (err, payload) {
            if (err)
                return cb(err, null);
            return cb(err, payload["patients"]);
        });
    ...
    PatientService.prototype.findPatientsByMedCard = function (medCard, limit, offset, cb) {
        this.exec(Handlers.HANDLER_FIND_PATIENTS_BY_MEDCARD_METHOD, { medcardNumber: medCard, limit: limit, offset: offset }, function (err, payload) {
            if (err)
                return cb(err, null);
            return cb(err, payload["patients"]);
        });

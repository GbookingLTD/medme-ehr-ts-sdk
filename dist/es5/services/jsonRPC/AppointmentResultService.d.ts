...
export declare class AppointmentResultService extends JsonRPCCredService implements IAppointmentResultService {
    ...
    getPatientAppointmentResults(patientId: string, limit: number, offset: number, cb: (err: any, appointmentResults: AppointmentResultMessage[]) => void, OrderByDescendingDate?: boolean): void;
    getPatientAppointmentResultsAsync(patientId: string, limit: number, offset: number, OrderByDescendingDate?: boolean): Promise<AppointmentResultMessage[]>;
    getAppointmentResults(limit: number, offset: number, lastId: string, cb: (err: any, appointmentResults: AppointmentResultMessage[]) => void, OrderByDescendingDate?: boolean): void;
    getAppointmentResultsAsync(limit: number, offset: number, lastId: string, OrderByDescendingDate?: boolean): Promise<AppointmentResultMessage[]>;
